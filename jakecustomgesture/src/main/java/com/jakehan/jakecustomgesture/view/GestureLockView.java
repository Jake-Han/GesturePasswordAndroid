package com.jakehan.jakecustomgesture.view;
...
import com.jakehan.jakecustomgesture.R;
import com.jakehan.jakecustomgesture.listener.OnGestureLockListener;
import com.jakehan.jakecustomgesture.model.Point;
import com.jakehan.jakecustomgesture.painter.GestureLockPainter;
import com.jakehan.jakecustomgesture.painter.Painter;
import com.jakehan.jakecustomgesture.util.DimensionUtil;
...
/**
 * Created by Jake Han on 2020/05/11 15:54
 */
public class GestureLockView extends View{
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mIsShowPath = array.getBoolean(R.styleable.GestureLockView_is_show_path,true);
        array.recycle();
        // 2.修正部分参数（防止参数越界）
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIsLineTop) { // 是否是"连线"显示在上层
            // 绘制3x3点数组
            mPainter.drawPoints(mPoints, canvas,mIsShowPath);
//            // 绘制连线
            mPainter.drawLines(mPressPoints, mEventX, mEventY, mLineThickness, canvas,mIsShowPath);
        } else {
            // 绘制连线
            mPainter.drawLines(mPressPoints, mEventX, mEventY, mLineThickness, canvas,mIsShowPath);
            // 绘制3x3点数组
