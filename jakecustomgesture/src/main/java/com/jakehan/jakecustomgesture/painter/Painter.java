package com.jakehan.jakecustomgesture.painter;
...
import com.jakehan.jakecustomgesture.view.GestureLockView;
import com.jakehan.jakecustomgesture.model.Point;
import com.jakehan.jakecustomgesture.util.BitmapUtil;

import java.util.List;

/**
 * Created by Jake Han on 2020/05/11 15:51
 */
public abstract class Painter {
     ...
     * @param canvas 画布
     */
    public final void drawPoints(Point[][] points, Canvas canvas,boolean isShow) {
...
//        canvas.drawBitmap(Bitmap.createScaledBitmap(bitmap, radius * 2, radius * 2, false), point.x - radius, point.y - radius, null);
     ...
     * @param canvas   画布
     */
    public void drawLines(List<Point> points, float eventX, float eventY, int lineSize, Canvas canvas,boolean isShow) {
        // 1.参数合法性判断
        if (points.size() <= 0) {
            return;
        }
